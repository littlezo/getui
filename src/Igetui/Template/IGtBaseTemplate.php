<?php
namespace Gt\Client\Igetui\Template;


use Exception;
use Gt\Client\Igetui\IGtAPNPayload\DictionaryAlertMsg;
use Gt\Client\Igetui\IGtAPNPayload\IGtAPNPayload;
use Gt\Client\Igetui\IGtReq\PushInfo;
use Gt\Client\Igetui\IGtReq\SmsContentEntry;
use Gt\Client\Igetui\IGtReq\SmsInfo;
use Gt\Client\Igetui\IGtReq\Transparent;
