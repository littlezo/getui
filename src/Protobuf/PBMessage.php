<?php
namespace Gt\Client\Protobuf;
use Exception;
use Gt\Client\Protobuf\Encoding\Base128Varint;
use Gt\Client\Protobuf\Reader\PBInputStringReader;
use Gt\Client\Protobuf\Type\PBInt;
use Gt\Client\Protobuf\Type\PBString;
use Gt\Client\Protobuf\Type\PBBool;
use Gt\Client\Protobuf\Type\PBBytes;
use Gt\Client\Protobuf\Type\PBEnum;
use Gt\Client\Protobuf\Type\PBScalar;
use Gt\Client\Protobuf\Type\PBSignedInt;
use Gt\Client\Protobuf\Type\TypeHelp;
...
abstract class PBMessage
{
    ...
    private function _ParseFromArray($length=99999999)
    {
        ...
        while ($this->reader->get_pointer() - $_begin < $length)
        {
            ...
            {
                $className = '\Gt\Client\Protobuf\Type\'' . $this->fields[$messtypes['field']];
                $this->values[$messtypes['field']][] = new $className($this->reader);
            ...
            {
                $this->values[$messtypes['field']] = TypeHelp::newType($this->fields[$messtypes['field']], $this->reader);
    ...
    {
        return $this->values[$index][] = TypeHelp::newType($this->fields[$index]);
    }
    ...
    protected function _set_value($index, $value)
    {
        ...
        {
            $this->values[$index] = TypeHelp::newType($this->fields[$index]);
