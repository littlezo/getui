...
//require_once(dirname(__FILE__) . '/' . 'Igetui/IGtReq.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/IGtMessage.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/IGtAppMessage.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/IGtListMessage.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/IGtSingleMessage.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/IGtTarget.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/Template/IGtBaseTemplate.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/Template/IGtLinkTemplate.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/Template/IGtNotificationTemplate.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/Template/IGtTransmissionTemplate.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/Template/IGtNotyPopLoadTemplate.php');
//require_once(dirname(__FILE__) . '/' . 'Igetui/Template/IGtAPNTemplate.php');
...
use Exception;
use Gt\Client\Igetui\Utils\ApiUrlRespectUtils;
use Gt\Client\Igetui\Utils\GTConfig;
use Gt\Client\Igetui\Utils\HttpManager;
use Gt\Client\Igetui\Utils\LangUtils;
use Gt\Client\Igetui\IGtListMessage;
use Gt\Client\Igetui\IGtMessage;
