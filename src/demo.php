...
use Gt\Client\Exception\RequestException;
use Gt\Client\Igetui\IGtAPNPayload\DictionaryAlertMsg;
use Gt\Client\Igetui\IGtAPNPayload\IGtAPNPayload;
use Gt\Client\Igetui\IGtAppMessage;
use Gt\Client\Igetui\IGtListMessage;
use Gt\Client\Igetui\IGtMultiMedia\IGtMultiMedia;
use Gt\Client\Igetui\IGtMultiMedia\MediaType;
use Gt\Client\Igetui\IGtReq\NotifyInfo_Type;
use Gt\Client\Igetui\IGtSingleMessage;
use Gt\Client\Igetui\IGtTagMessage;
use Gt\Client\Igetui\IGtTarget;
use Gt\Client\Igetui\Template\IGtLinkTemplate;
use Gt\Client\Igetui\Template\IGtNotificationTemplate;
use Gt\Client\Igetui\Template\IGtNotyPopLoadTemplate;
use Gt\Client\Igetui\Template\IGtTransmissionTemplate;
use Gt\Client\Igetui\Template\Notify\IGtNotify;
use Gt\Client\Igetui\Template\Notify\SmsMessage;
use Gt\Client\Igetui\Utils\ApnsUtils\AppConditions\AppConditions;
use Gt\Client\IGeTui;
use Gt\Client\IGtBatch;
...
require_once(dirname(__FILE__) . '/' . 'Igetui/IGtTagMessage.php');
...
require_once(dirname(__FILE__) . '/' . 'Igetui/Template/Notify/IGtNotify.php');
require_once(dirname(__FILE__) . '/' . 'Igetui/IGtMultiMedia.php');
